...
<div class="container text-center pt-5">
    <div class="row justify-content-start">
        <span class="col-auto phim-hot-btn shadow d-flex align-items-center gap-2">
            <i class="fas fa-fire"></i> <a href="#" class="text-decoration-none text-white">PHIM HOT</a>
        </span>
    </div>
</div>
